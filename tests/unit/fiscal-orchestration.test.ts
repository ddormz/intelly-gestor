...
vi.mock("@/features/billing/xml", () => ({ parseSignedDteXmlBytes: vi.fn(() => ({ type: "33", folio: 42, issueDate: "2026-08-15", dueDate: null, issuer: { rut: "76123456-7", name: "EMISOR", businessLine: null, activity: null, address: null, commune: null, city: null }, receiver: { rut: "12345678-5", name: "CLIENTE SPA", businessLine: "Comercio", address: "Destino", commune: "Providencia", city: "Santiago" }, details: [], totals: { net: 1000, exempt: 0, ivaRate: 19, iva: 190, total: 1190 }, references: [], resolution: { date: null, number: null }, tedXml: "<TED/>", sourceXml: "xml" })), renderFiscalPdf: vi.fn(async () => new Uint8Array(Buffer.from("%PDF-fiscal"))) }));
