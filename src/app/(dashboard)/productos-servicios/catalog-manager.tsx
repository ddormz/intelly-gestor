...
import { createCatalogItemAction, setCatalogItemStatusAction, updateCatalogItemAction } from "@/features/catalog/actions";
...
export function CatalogManager({ items }: { items: CatalogListItem[] }) {
  ...
  return <div className="space-y-6">
    <PageHeader title="Productos o Servicios" description="Define conceptos reutilizables con precio e IVA consistente." action={create} />
